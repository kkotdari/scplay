...
/** 어두운 쪽 끌어올리기(1이면 원본 그대로). 0.55 → 0.68(지적: "맵 타일 그리기 너무 밝다 — 어둡고 진하게"):
 *  흙 (79,66,49)이 (140,127,110)에서 (115,102,83)쯤으로 내려온다.
 *  0.68 → 0.78(요청: "전체적으로 빛을 줄여 원작의 진하고 살짝 어두운 색감") — 흙이 (102,90,72)까지
 *  내려와 원작 평균(79,66,49)에 한 걸음 더 다가선다. 유닛 쪽 tone9과 한 결이다. */
const SHOW_GAMMA = 0.78;
/** 색 벌리기 — 휘도는 그대로 두고 채도만 곱한다(1이면 그대로). 어두워진 만큼 색이 묻히지 않게 1.8 → 2.1 → 2.25. */
const SHOW_SAT = 2.25;
