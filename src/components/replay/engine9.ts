...
export const MODEL_NORM: Record<string, number> = {
  ...
  hydra: 0.687,  // 머리장식 끝선의 각·납작한 갈비·가슴 갑옷 뒤 재측정(model-norm의 **top 모드** 표 — base 모드 값을 실으면 안 된다)
...
export const BLD_NORM: Record<string, number> = {
  ...
  creep: 1.150,  // ×0.8(요청: 그리기 0.8배) · 발 셋 이식·본체 요잉 −45도·발만 −45도 뒤 재측정 1.438 · 옛 1.232
  ctower: 1.555,
  cube: 1.112,
...
export const FX_BEAM: Record<string, {
  ...
  missileG: { dur: 0.28, w: 0.15, l: 24, puff: 8.4, smoke: "#f4eddc", smokeEdge: "#ffe6a8", smokeFade: 0.95, warhead: "#c9a132", g: [[0, "rgba(248,238,214,1)"], [0.1, "rgba(240,226,190,0.94)"], [0.32, "rgba(224,206,160,0.6)"], [0.68, "rgba(190,170,120,0.32)"], [1, "rgba(160,142,100,0)"]], glow: "rgba(235,210,150,0.5)" },
