...
export const BLD_INK_MID9: Record<string, [number, number]> = { tomb: [4.56, 3.92], trapezoid: [2.78, 2.40], refinery: [4.04, 3.43], cube: [7.13, 6.53], ebay: [5.42, 4.57], tombFlat: [3.37, 2.77], academy: [4.14, 3.61], turret: [5.53, 4.93], factory: [4.31, 3.77], plane: [5.61, 4.90], armory: [4.14, 3.56], scifac: [3.31, 2.83], comsat: [3.06, 2.79], nsilo: [3.23, 2.84], mshop: [2.85, 2.50], ctower: [3.09, 2.63], covert: [2.40, 2.03], physlab: [2.60, 2.25], pyramidWide: [6.02, 5.10], diamond: [4.83, 4.25], assim: [2.88, 2.56], gate: [3.07, 2.62], forge: [3.90, 3.34], coil: [4.88, 4.02], sbattery: [3.05, 2.56], cyber: [3.19, 2.78], citadel: [4.07, 3.46], archives: [3.40, 2.82], dome: [4.10, 3.52], robobay: [3.05, 2.64], observatory: [3.07, 2.66], arch: [3.11, 2.70], fleetbeacon: [3.53, 3.09], tribunal: [3.05, 2.59], warpin: [4.48, 4.48], hatchery: [4.49, 3.81], lair: [5.62, 4.97], hive: [6.31, 5.67], creep: [3.96, 3.33], sunken: [4.64, 3.80], spore: [4.34, 3.76], extract: [4.65, 3.97], pool: [4.05, 3.24], evo: [4.46, 3.75], hydraden: [5.46, 4.88], spire: [6.53, 5.87], gspire: [10.23, 9.26], queensnest: [4.68, 4.00], nydus: [4.45, 3.72], cavern: [4.36, 3.57], dmound: [4.71, 3.89], cocoon: [2.37, 1.94], sunkenfire: [5.83, 5.05], mineral: [3.26, 2.75], mineralb: [4.05, 3.43], mineralc: [3.50, 2.93], geyser: [2.88, 3.18], nuke: [4.19, 3.89], storm: [3.15, 2.92], nukeblast: [5.08, 4.08], nukecloud: [6.69, 5.89], tankbody: [3.07, 2.69], tankgun: [1.79, 1.58], tanksiegebody: [3.60, 3.13], tanksiegegun: [1.95, 1.72], tanksiegelegs: [0.93, 0.78], addonlink: [3.95, 3.41], burrowhole: [2.67, 2.16], lurkerburrow: [2.67, 2.17], lurkerfire: [2.70, 2.21], creeppatch: [4.11, 3.33], creeppatch2: [4.11, 3.33], creeppatch3: [4.12, 3.34] };
