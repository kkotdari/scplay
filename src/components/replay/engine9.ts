...
export const MODEL_NORM: Record<string, number> = {
  ...
  droneGas: 0.933,
  droneMin: 0.958,
  dship: 0.661,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
  ...
  scv: 0.692,  // 어깨 걷고 팔을 한 자락으로 편 뒤 재측정(model-norm top 0.760 → 0.739)
  scvGas: 0.766,   // 어깨 걷고 짐 자리를 옮긴 뒤 재측정(model-norm top 0.854 → 0.810)
  scvMin: 0.774,   // 어깨 걷고 짐 자리를 옮긴 뒤 재측정(model-norm top 0.864 → 0.818)
...
export const FX_BEAM: Record<string, {
  ...
  flame: { muzzleLit: true, dur: 0.3, w: 2.0, l: 5.0, cone: [0.45, 2.4], glow: "rgba(255,146,48,0.55)", glowW: 1.7, glowA: 0.6, g: [[0, "rgba(255,252,236,0.98)"], [0.1, "rgba(255,238,168,0.98)"], [0.3, "rgba(255,186,68,0.95)"], [0.58, "rgba(255,112,32,0.86)"], [0.82, "rgba(196,52,18,0.45)"], [1, "rgba(96,36,24,0)"]] },
