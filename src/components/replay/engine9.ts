...
export const MODEL_NORM: Record<string, number> = {
  ...
  scout: 0.772,  // 날개 수직·뒤로 · 카혼 엔진 · 동체 앞으로 늘린 뒤 재측정(model-norm)
...
export const BLD_NORM: Record<string, number> = {
  ...
  cocoon: 1.760,  // 밑동의 장기 파이프(173개·곧은 앞머리+큰 반지름 호)·정수리 핏줄 뒤 재측정(bld-norm)
  coil: 1.337,
  comsat: 1.366,
