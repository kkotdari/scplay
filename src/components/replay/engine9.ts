...
export const BLD_NORM: Record<string, number> = {
  ...
  cocoon: 2.316,  // 밑동의 장기 파이프(144개·반원 호·0.6배·위2 대각2 옆6)·정수리 핏줄 뒤 재측정(bld-norm)
  coil: 1.337,
  comsat: 1.366,
