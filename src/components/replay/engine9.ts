...
export const MODEL_NORM: Record<string, number> = {
  ...
  scourge: 1.095,  // 상자 상한(원한 배수 1.327) · 재작도 뒤 1.174(1.271 → 1.243) · 팔을 바깥 테두리로 뒤 ×0.9324(1.243 → 1.159)
...
export const BLD_NORM: Record<string, number> = {
  ...
  fleetbeacon: 1.551,  // ×0.8(요청: 그려지는 크기 0.8배) · 재작도(접시 받침·팔 여섯·포신·그릇) 뒤 ×0.9125(2.125 → 1.939)
