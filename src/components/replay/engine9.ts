...
export const MODEL_NORM: Record<string, number> = {
  ...
  burrowhole: 0.732,
  carrier: 0.644,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
