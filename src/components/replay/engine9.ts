...
export const MODEL_NORM: Record<string, number> = {
  ...
  darchon: 0.496,
  defiler: 0.884,   // ×(0.765/0.745) 앞·뒷다리 무릎 안쪽 꺾기(잉크 폭이 준 만큼 — 몸 크기는 그대로) · 0.687 → ×1.2(요청: 디파일러 그리기 1.2배) → ×(0.700/0.649) 다리 0.8배·뒷다리 뒤로 → ×(0.720/0.700) 세 쌍 손질(실측 0.700→0.720) → ×(0.745/0.720) 뒷다리 과감히 뒤로·0.9배(실측 0.720→0.745)
