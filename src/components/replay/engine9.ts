...
export const BLD_NORM: Record<string, number> = {
  ...
  scifac: 1.449,  // 재작도 + 삼중탑 제거·왼판 축소 · 다리 기둥 20% 축소 · 받침 들고 다리 들인 뒤 재측정(1.426 → 1.449)
