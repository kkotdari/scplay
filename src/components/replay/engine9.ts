...
export const BLD_NORM: Record<string, number> = {
  ...
  sbattery: 2.050,  // 다리를 직각으로 꺾어 발자국이 좁아진 뒤 재측정(bld-norm) · 옛 1.951
