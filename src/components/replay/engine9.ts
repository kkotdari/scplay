...
export const MODEL_NORM: Record<string, number> = {
  ...
  tanksiege: 0.695,
  tanksiegebody: 0.687,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
