...
export const FX_BEAM: Record<string, {
  ...
  /* ★ 디바우러의 산 — **뭉게뭉게한 연기 구름**이다(2026-09, 요청: "디바우러 트레이서도 연기
     ...
     ★ 크기 **40% 축소**(2026-09, 요청: "디바우러 트레이서 크기 40프로 축소") — 굵기 1.6 → 0.96 · 길이 2.6 → 1.56.
       덩이 지름은 굵기(w)에 매여 있어 함께 준다(billowK 는 그대로). */
  acid: { dur: 0.75, w: 0.96, l: 1.56, g: [[0, "rgba(206,150,255,0.95)"], [0.2, "rgba(206,150,255,0.95)"], [0.6, "rgba(150,80,220,0.7)"], [1, "rgba(110,50,170,0)"]],
