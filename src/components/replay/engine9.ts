...
export const MODEL_NORM: Record<string, number> = {
  ...
  burrowhole: 0.732,
  carrier: 0.622,   // 잎 등마루를 세워 실루엣이 3.3% 커진 몫(model-norm top 0.658 → 0.636)
  ...
  interceptor: 1.432,  // 콩가 꼴로 바꿔 실루엣이 1.6% 작아진 몫(model-norm top 1.472 → 1.495)
