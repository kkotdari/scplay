...
export const FX_BEAM: Record<string, {
  ...
  flame: { muzzleLit: true, dur: 0.34, w: 1.05, l: 9.5, cone: [0.5, 1.5], glow: "rgba(255,146,48,0.5)", glowW: 1.55, glowA: 0.5,
  ...
  yamato: { dur: 0.85, w: 2.6, l: 2.0, glow: "rgba(150,200,255,0.75)", glowW: 1.7, glowA: 0.65,
    g: [[0, "rgba(255,255,255,0.98)"], [0.18, "rgba(255,255,255,0.95)"], [0.42, "rgba(160,205,255,0.85)"], [0.72, "rgba(95,145,255,0.42)"], [1, "rgba(95,145,255,0)"]] },
...
export const FX_IMPACT: Record<string, {
  ...
  // 야마토 착탄 — 흰 속·푸른 테가 넓게 퍼진다(줄기와 같은 결).
  yamato: { r: 1.6, g: [[0, "rgba(255,255,255,0.98)"], [0.3, "rgba(178,215,255,0.7)"], [0.7, "rgba(95,145,255,0.3)"], [1, "rgba(95,145,255,0)"]], ring: "rgba(198,225,255,0.5)" },
      ...
      if (beamLen > 1 && (MUZZLE_BURST_FX9.has(fxName9) || SHELL_ONLY_FX9.has(fxName9))) {
        ...
        if (uS9 < 1) {
          ...
          put9(bx9, by9, fxPx * 0.34, "tankshell", 0.3,
            (Math.atan2(-(tvx9 - mzx9), tvy9 - mzy9) * 180) / Math.PI);
        } else {
