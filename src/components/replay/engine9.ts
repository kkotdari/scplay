...
export const MODEL_NORM: Record<string, number> = {
  ...
  scourge: 1.133,  // 상자 상한(원한 배수 1.327) · 재작도 1.174 · 팔 바깥 1.095(1.243 → 1.159) · 팔·막 180도 피칭 뒤 ×1.0345(1.159 → 1.199)
...
export const BLD_NORM: Record<string, number> = {
  ...
  fleetbeacon: 1.542,  // ×0.8(요청) · 재작도 1.551(2.125 → 1.939) · 팔 끝 뭉툭·앞 말굽 뒤 ×0.9943(1.939 → 1.928)
