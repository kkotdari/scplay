...
export const FX_BEAM: Record<string, {
  ...
  flame: { muzzleLit: true, dur: 0.34, w: 1.05, l: 9.5, cone: [0.5, 1.5], glow: "rgba(255,146,48,0.5)", glowW: 1.55, glowA: 0.5, g: [[0, "rgba(255,252,236,0.98)"], [0.07, "rgba(255,240,176,0.98)"], [0.2, "rgba(255,190,72,0.95)"], [0.42, "rgba(255,116,34,0.88)"], [0.62, "rgba(214,80,30,0.7)"], [0.78, "rgba(152,114,100,0.46)"], [0.9, "rgba(128,120,114,0.26)"], [1, "rgba(118,112,108,0)"]] },
