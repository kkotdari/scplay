...
export const MODEL_NORM: Record<string, number> = {
  ...
  egg: 0.915,   // 받침 발톱 일곱·거품 테를 두른 뒤 재측정(옛 1.210 — 발톱이 밖으로 뻗어 잉크가 넓어졌다)
...
export const UNIT_INK_CY9: Record<string, [number, number]> = { scv: [7.91, 8.70], gunner: [10.29, 10.99], ghost: [10.26, 10.95], fbat: [10.19, 10.90], inf: [10.26, 10.96], vulture: [9.30, 10.00], tank: [11.15, 11.63], goliath: [9.79, 10.49], wraith: [8.21, 9.02], dship: [8.42, 9.22], vessel: [9.59, 10.31], valk: [8.23, 9.03], bc: [9.16, 9.91], scvMin: [7.88, 8.72], scvGas: [7.82, 8.69], tanksiege: [11.02, 11.48], mine: [11.66, 12.28], probe: [10.14, 10.84], zealot: [9.50, 10.24], goon: [9.70, 10.42], htemp: [9.10, 9.83], dtemp: [10.10, 10.73], archon: [8.79, 9.57], darchon: [8.78, 9.56], shuttle: [8.37, 9.06], reaver: [10.65, 11.31], observer: [9.40, 10.13], scout: [8.01, 8.82], corsair: [8.68, 9.47], carrier: [9.37, 10.07], interceptor: [6.54, 7.45], scarab: [10.97, 11.63], arbiter: [8.32, 8.85], larva: [11.33, 11.96], egg: [11.28, 11.87], probeMin: [10.33, 11.00], probeGas: [10.34, 11.03], drone: [9.81, 10.53], ovie: [9.17, 9.94], zling: [10.24, 10.93], hydra: [8.76, 9.51], lurker: [9.74, 10.44], muta: [7.54, 8.44], scourge: [7.03, 7.91], queen: [7.85, 8.64], ultra: [9.07, 9.65], defiler: [11.19, 11.83], guardian: [7.64, 8.47], devourer: [8.91, 9.68], lurkeregg: [11.73, 12.26], mutacocoon: [9.51, 10.25], droneMin: [9.81, 10.53], droneGas: [9.78, 10.50], tankbody: [11.24, 11.77], tankgun: [9.79, 10.21], tanksiegebody: [11.18, 11.71], tanksiegegun: [9.59, 9.99], burrowhole: [11.83, 12.44] };
