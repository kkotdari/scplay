...
export const MODEL_NORM: Record<string, number> = {
  ...
  hydra: 0.618,  // 머리장식 셋(가운데 삼각 뿔이 길어졌다)·가슴 갑옷판 뒤 재측정(model-norm)
...
export const BLD_NORM: Record<string, number> = {
  ...
  creep: 1.134,  // ×0.8(요청: 그리기 0.8배) · 성큰 발 셋 이식 뒤 재측정 1.417 · 옛 1.232
  ctower: 1.555,
  cube: 1.112,
  ...
  sunken: 0.978,  // ×0.8(요청: 그리기 0.8배) · 왼쪽 큰 발 뒤 재측정 1.222 · 옛 1.046
  sunkenfire: 1.391,
  tomb: 1.534,
