...
export const BLD_NORM: Record<string, number> = {
  ...
  pyramidWide: 1.159,  // 재측정(bld-norm) — 기둥 5.5·원기둥 받침·표창 길이 원복 뒤 · 기둥을 모퉁이 위로(4.6) 들인 뒤 ×1.109(1.063 → 1.179)
  ...
  sunkenfire: 1.377,   // 혓바닥 역 U·반구 끝 1.394 · 굵기 2배·높이 3배 ㄇ자 뒤 ×0.9899(1.285 → 1.272) · 아치 뒤 ×0.998(1.272 → 1.270)
