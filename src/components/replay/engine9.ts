...
export const MODEL_NORM: Record<string, number> = {
  ...
  scv: 0.724,  // 자락 25%·뿌리 물림·관절 구 뒤 재측정(model-norm top 0.739 → 0.773)
  scvGas: 0.797,   // 자락 25%·뿌리 물림 뒤 재측정(model-norm top 0.810 → 0.843)
  scvMin: 0.808,   // 자락 25%·뿌리 물림 뒤 재측정(model-norm top 0.818 → 0.854)
