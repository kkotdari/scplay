...
export const MODEL_NORM: Record<string, number> = {
  ...
  htemp: 1.140,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
  ...
  scvGas: 0.808,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
  scvMin: 0.817,   // 모델 z 손질 재측정 되돌림(2D 기하 복원)
  shuttle: 0.730,  // 앞 말굽 끝을 여민 뒤 재측정(model-norm top 0.759 → 0.764)
...
export const UNIT_INK_CY9: Record<string, [number, number]> = { scv: [7.86, 8.69], gunner: [10.29, 10.99], ghost: [10.26, 10.95], fbat: [10.19, 10.90], inf: [10.26, 10.96], vulture: [9.30, 10.00], tank: [11.17, 11.78], goliath: [9.79, 10.49], wraith: [8.21, 9.02], dship: [8.43, 9.22], vessel: [9.59, 10.31], valk: [8.23, 9.03], bc: [9.16, 9.91], scvMin: [7.86, 8.70], scvGas: [7.83, 8.67], tanksiege: [11.01, 11.64], mine: [11.66, 12.28], probe: [10.10, 10.80], zealot: [9.69, 10.42], goon: [9.70, 10.42], htemp: [9.21, 9.95], dtemp: [10.20, 10.85], archon: [8.79, 9.57], darchon: [8.78, 9.56], shuttle: [8.33, 9.06], reaver: [10.65, 11.31], observer: [9.39, 10.13], scout: [8.01, 8.82], corsair: [8.68, 9.47], carrier: [9.42, 10.07], interceptor: [6.54, 7.45], scarab: [10.97, 11.63], arbiter: [10.39, 11.08], larva: [11.33, 11.96], egg: [11.28, 11.87], probeMin: [10.29, 10.97], probeGas: [10.31, 11.00], drone: [9.81, 10.53], ovie: [9.17, 9.94], zling: [10.24, 10.93], hydra: [8.86, 9.62], lurker: [9.74, 10.44], muta: [7.54, 8.44], scourge: [7.03, 7.91], queen: [7.85, 8.64], ultra: [9.41, 10.13], defiler: [11.19, 11.83], guardian: [7.64, 8.47], devourer: [8.90, 9.71], lurkeregg: [11.73, 12.26], mutacocoon: [9.51, 10.25], droneMin: [9.81, 10.53], droneGas: [9.78, 10.50], tankbody: [11.24, 11.87], tankgun: [9.82, 10.52], tanksiegebody: [11.18, 11.82], tanksiegegun: [9.59, 10.31], burrowhole: [11.83, 12.44] };
