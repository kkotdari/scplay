...
void main() {
  ...
  float sheen = (0.10 + 0.90 * smoothstep(0.15, 1.00, ndl)) * uGloss.w * (0.30 + 0.70 * lum);
...
const GLOSS_TERRAN9: Gloss9 = [14, 0.50, 0.30, 0.16, 0.85];
const GLOSS_TOSS9: Gloss9 = [18, 0.44, 0.70, 0.14, 0.35];
...
const GLOSS_ZERG9: Gloss9 = [12, 0.22, 0.15, 0.08, 0];
const GLOSS_NONE9: Gloss9 = [14, 0.12, 0.30, 0.06, 0.15];
